...
\left[\frac{1}{\sqrt{2\pi\sigma^2}}\right]^{n_o}\:\cdot{}\:\prod_{t=1}^{n_o}\:\mathrm{exp}\left[{-\frac{1}{2}\left(\frac{\hat{x}_t-\tilde{x}_t}{\sigma}\right)^2}\right]
\end{equation}
and since
\begin{equation}
...
p\,(\,\hat{\mathbf{x}}\,|\,\tilde{\mathbf{x}},\sigma\,) =
\left[\sqrt{2\pi\sigma^2}\right]^{-n_o}\:\cdot{}\:\prod_{t=1}^{n_o}\:\mathrm{exp}\left[{-\frac{1}{2}\left(\frac{\hat{x}_t-\tilde{x}_t}{\sigma}\right)^2}\right]
\end{equation}
Furthermore,
\begin{equation}
...
p\,(\,\hat{\mathbf{x}}\,|\,\tilde{\mathbf{x}},\sigma\,) =
\left[\sqrt{2\pi\sigma^2}\right]^{-n_o}\:\cdot{}\:\mathrm{exp}\left[-\frac{1}{2}\sum_{t=1}^{n_o}\left(\frac{\hat{x}_t-\tilde{x}_t}{\sigma}\right)^2\right]
\end{equation}
...
\mathrm{log}\left[\sqrt{2\pi\sigma^2}\right]\:+\:\left[-\frac{1}{2}\sum_{t=1}^{n_o}\left(\frac{\hat{x}_t-\tilde{x}_t}{\sigma}\right)^2\right]
\end{equation}
...
\ell\,(\,\hat{\mathbf{x}}\,|\,\tilde{\mathbf{x}},\sigma\,) =
-\frac{1}{2}n_o\cdot{}\mathrm{log}\left(2\pi\right)\:-\:\frac{1}{2}n_o\cdot{}\mathrm{log}\left(\sigma^2\right)\:-\:\frac{1}{2}\sum_{t=1}^{n_o}\left(\frac{\hat{x}_t-\tilde{x}_t}{\sigma}\right)^2
\end{equation}
...
-\frac{1}{2}n_o\cdot{}\mathrm{log}\left(2\pi\right)\:-\:\frac{1}{2}n_o\cdot{}\mathrm{log}\left(s^2\right)\:-\:\frac{1}{2}\sum_{t=1}^{n_o}\left(\frac{\hat{x}_t-\tilde{x}_t}{s}\right)^2
\end{equation}
