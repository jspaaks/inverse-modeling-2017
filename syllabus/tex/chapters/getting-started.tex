...
\smallqo{Use the \texttt{prctile} function to construct a plot that shows
\texttt{yObs}, the best-scoring \texttt{ySim}, together with the median and
95\% confidence interval.}

% TODO introduce evalResults
