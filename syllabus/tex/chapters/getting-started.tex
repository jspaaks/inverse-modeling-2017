...
We will take you through these basic steps (see also
Fig.~\ref{fig:diff-evo-principle}):
\begin{enumerate}
...
\begin{figure}[htbp]
  ...
  \texttt{children} from the first generation are the \texttt{parents} for the
  next generation.}
...
Repeat for all samples in \mcode{parents}.}
